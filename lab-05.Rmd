...
Observation: 953
Variables: 26
each row reprenst information about a nobel prize winner.
...
```{r}
mobl_living_science <- nobel_living_science %>% mutate(born_country_us = if_else(born_country == "USA", "USA", "Other"))
```
